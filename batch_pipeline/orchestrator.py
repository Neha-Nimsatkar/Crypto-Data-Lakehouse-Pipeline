...
Location    : batch_pipeline/
Description : Master pipeline orchestrator that executes the files in exact sequence:
...
def run_script_via_cli(script_relative_path):
    ...
    # Finding current script base directory to build absolute paths dynamically
    ...
    # Executing the script as a sub-process to maintain environment isolation
